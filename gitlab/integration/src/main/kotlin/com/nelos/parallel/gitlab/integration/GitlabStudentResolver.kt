...
import com.nelos.parallel.pipeline.commons.service.StudentResolver
...
class GitlabStudentResolver(
    ...
    override fun resolveOrAutoCreate(externalId: String): Long {
        val user = existingUser(externalId) ?: createMapping(externalId)
        return user.id ?: error("Resolved user has no id")
    }
